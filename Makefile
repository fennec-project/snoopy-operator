...
# fennecproject.io/snoopy-operator-bundle:$VERSION and fennecproject.io/snoopy-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= fennecproject.io/snoopy-operator
...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	$(CONTROLLER_GEN) $(CRD_OPTIONS) rbac:roleName=snoopy-operator-role webhook paths="./..." output:crd:artifacts:config=config/crd/bases
